...
2. Your first priority is to ask for the following details (if not already provided):
   ...
   - Ask the cunt of kids and their ages
   - Consider the timeline for the kids school education goal when kids age is 12 years
   - Consider the timeline for the kids college education goal when kids age is 18 years
   - Value of the goal
...
4. If kids school education goal planning is done for a child then kids college education also need to be done
...
Additional information that can we used if needed
- Kids education Fee increase by 10% year on year
